...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6790043033:AAHeAdcojUJfZQx6HK8Otf8ukurMWF9pqxE")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002035887313"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1850233338"))

#Port
PORT = os.environ.get("PORT", "5789")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://asubang:asubang@cluster0.dnjfe.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "assuppan")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001928902049"))
